...
<nav class="navbar navbar-expand-lg bg-info">
 ...
 <!--  <h1>You have logined successfully</h1>
  ...
  <div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">View Customer</h6>
    <p class="card-text">Click here to view information related to a customer</p>
    <a href="listCustomer.jsp" class="btn btn-primary">Customer</a>
 ...
 <div class="card text-bg-dark border-primary" style="width: 20rem;margin-top:200px;margin-left:20px">
  <div class="card-body">
    ...
    <p class="card-text">Click here to view information related to a account</p>
    <a href="Account.jsp" class="btn btn-primary">Account</a>
    <!--  <a href="#" class="btn btn-primary">Another link</a> -->
  </div>
</div>
