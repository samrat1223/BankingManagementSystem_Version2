...
<div class="wrapper">
        ...
        <form method="POST">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="text" placeholder="Enter your Account Number" required class="name">
            ...
            <div class="input-group">
                <div class="input-box">
                    <input type="text" placeholder="Enter your IFSC Code" required class="name">
                    <i class="fa fa-user icon"></i>
                </div>
            </div>
                <h4>Amount</h4>
            <div class="input-group">
                <div class="input-box">
                    <input type="text" placeholder="Enter Amount to Deposit" required class="name">
                    <i class="fa fa-user icon"></i>
                </div>
            </div>
            <div class="input-group">
